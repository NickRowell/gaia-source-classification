...
/**
 * This class provides a self-contained application that can be used to test, develop and train the
 * 2D source detection and classification algorithms in an interactive environment.
 * 
 * @author nrowell
 * @version $Id$
 */
...
//	SourceClassifier sourceClassifier = new SourceClassifierNN();
	...
	/**
	 * The {@link TrainingSetPanel} used to manipulate the training set.
	 */
	TrainingSetPanel trainingSetPanel;
	...
	public GaiaSourceClassificationPanel(Mode mode, File outputDir) {
		...
		if(mode==Mode.MANUAL) {
			...
			trainingSetPanel = new TrainingSetPanel(classifiedSources, outputDir);
