 ...
 * provides operations on it. This is for use in building a training set of {@link Source}s.
 *
 * @author nrowell
 * @version $Id$
 */
public class TrainingSetSourcePanel extends JPanel {
	 ...
	 */
	public TrainingSetSourcePanel(List<Source> classifiedSources, File outputDir) {
