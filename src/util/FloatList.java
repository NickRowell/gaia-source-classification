...
public class FloatList extends ArrayList<Float> {
	...
	public float getMedian() {
        ...
        float median = (N%2==0) ? (get(N/2-1) + get(N/2))/2.0f : get((N-1)/2);
	...
	/**
	 * Copies the list elements to an array of doubles.
	 * 
	 * @return	Array of doubles representing the List elements in proper sequence.
	 */
